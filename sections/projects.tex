...
\subsubsection{\href{https://github.com/newtlang}{https://codeberg.org/newtlang}}
-\:  Designed a markup language to be as simple as markdown, yet as flexible as \LaTeX \\
-\:  Implemented a custom Recursive-Descent parset to convert source markup to HTML \\
-\:  Designed an extension API for users to implement their own macros and environments \\
-\:  Currently rewriting it in another language for performance \\
-\:  Exploring possible options for tooling to make it usable \\
...
-\:  Set up a homelab to host various services in a containerised environment running on Linux \\
-\:  So far, I have set up Jellyfin, NFS, a Minecraft Server and a few other services \\
...
-\:  Assisted in the development of new gamemodes \\
